/* Fabulous Frogs - Picture Book Script */
(function () {
  "use strict";
  ...
  function showPage(index, direction) {
    ...
    // After transition, hide old page
    setTimeout(function () {
      oldPage.hidden = true;
      oldPage.classList.remove("page--exit-left", "page--exit-right");
    }, 500);
  ...
  document.addEventListener("touchend", function (e) {
    ...
    // Require horizontal swipe: at least 50px, more horizontal than vertical, under 500ms
  ...
  // Auto-dismiss hint after animation
  if (swipeHint) {
